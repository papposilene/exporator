...
return [
    ...
    */
    ...
    'exhibitions_for' => 'expositions ouvertes lors de l’année :year',
    ...
    'send_place_tweet' => 'le lieu d’exposition :name @:twitter vient d’être ajouté sur l’Exporateur.',
    'send_exhibition_tweetWith' => 'l’exposition « :what » du @:twitter vient d’être ajoutée sur l’Exporateur (:url). Plus d’informations sur :site.',
    'send_exhibition_tweetWithout' => 'l’exposition « :what » du :name vient d’être ajoutée sur l’Exporateur (:url). Plus d’informations sur :site.',
