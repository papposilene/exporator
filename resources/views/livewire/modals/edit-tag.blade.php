<div id="modalEditTag" class="relative float-right mr-2">
        ...
        <div class="bg-white dark:bg-gray-700 dark:text-white overflow-auto w-1/2 h-1/2 p-12">
            ...
            <form method="POST" action="{{ route('admin.tag.store') }}" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-2 gap-x-4 mt-4">
                    ...
                    <x-forms.label class="dark:text-gray-100" for="name">@ucfirst(__('app.tag'))</x-forms.label>
    ...
    <script>
        document.addEventListener('livewire:load', function () {
            ...
            modalOpenEditTag.addEventListener('click',()=>modalWindowEditTag.classList.remove('invisible'))
            modalCloseEditTag.addEventListener('click',()=>modalWindowEditTag.classList.add('invisible'))
        })
    </script>
</div>
