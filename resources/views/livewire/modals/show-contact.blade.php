...
document.addEventListener('livewire:load', function () {
    ...
    modalOpenShowContact.addEventListener('click',()=>modalWindowShowContact.classList.remove('scale-0'))
    modalCloseShowContact.addEventListener('click',()=>modalWindowShowContact.classList.add('scale-0'))
})
</script>
