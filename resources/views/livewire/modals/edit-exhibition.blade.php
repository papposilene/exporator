        ...
        <div class="bg-white dark:bg-gray-700 dark:text-white overflow-auto w-1/2 h-1/2 p-12">
            ...
            <form method="POST" action="{{ route('admin.exhibition.update') }}" enctype="multipart/form-data"
                ...
                <div class="mt-4">
                    ...
                    <x-forms.input id="place" class="dark:text-gray-800 dark:bg-bluegray-300 block mt-1 w-full" type="text" required value="{{ $exhibition->inPlace->name }}" />
                ...
                <div class="mt-4">
                    ...
                    <x-forms.input id="title" class="dark:text-gray-800 dark:bg-bluegray-300 block mt-1 w-full" type="text" name="title" :placeholder="@ucfirst(__('app.title'))" value="{{ $exhibition->title }}" required />
                </div>
                ...
                <div class="grid grid-cols-2 gap-x-4 mt-4">
                    ...
                    <x-forms.select id="public" class="dark:text-gray-800 dark:bg-bluegray-300 block mt-1 w-full" name="is_published" required>
                        ...
                        <option value="0">@ucfirst(__('app.no'))</option>
                    </x-forms.select>
                </div>
