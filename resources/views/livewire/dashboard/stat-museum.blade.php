<div class="flex-grow bg-purple-100 p-5 w-full">
    ...
    <ol class="list-inside list-disc">
        ...
        <li>
            <a href="{{ route('front.museum.index', ['filter' => 'foundation']) }}" class="text-blue-700 hover:text-red-600">
                @ucfirst(__('app.numbers_of_foundation_type', ['count' => $foundation_type]))
            </a>
        </li>
        <li>
            <a href="{{ route('front.museum.index', ['filter' => 'other']) }}" class="text-blue-700 hover:text-red-600">
