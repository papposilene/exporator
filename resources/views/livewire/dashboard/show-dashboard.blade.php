...
<div>
    ...
    <div>
        <div class="flex flex-col lg:flex-row flex-wrap max-w-7xl mx-auto py-5 px-6">
            <div class="flex flex-grow lg:flex-grow-0 flex-wrap bg-gray-300 lg:mr-2 p-5 shadow w-full lg:w-1/4">
            ...
            @auth
            <div class="flex flex-grow lg:flex-grow-0 flex-wrap bg-yellow-300 p-5 shadow w-full lg:w-3/4">
        ...
        <div class="flex flex-col lg:flex-row flex-wrap max-w-7xl mx-auto -mt-7 py-5 px-6">
            <div class="flex flex-grow lg:flex-grow-0 flex-wrap lg:mr-2 shadow w-full lg:w-1/3">
                <livewire:dashboard.stat-place />
            </div>
            <div class="flex flex-grow lg:flex-grow-0 flex-wrap lg:mr-2 shadow w-full lg:w-1/3">
                <livewire:dashboard.stat-exhibition />
            </div>
            <div class="flex flex-grow lg:flex-grow-0 flex-wrap shadow w-full lg:w-1/3">
