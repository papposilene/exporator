<nav x-data="{ open: false }" class="bg-white border-b border-bluegray-100 dark:bg-white dark:border-bluegray-900">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('front.exhibition.index') }}" class="text-bluegray-900 dark:text-bluegray-100"
