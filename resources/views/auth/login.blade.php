        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="block mt-4">
                <label for="remember_me" class="flex items-center">
                    ...
                    <span class="ml-2 text-sm text-bluegray-600">@ucfirst(__('auth.remember_me'))</span>
                </label>
            </div>

            <div class="flex items-center justify-end mt-4">
                @if (Route::has('password.request'))
                    <a class="underline text-sm text-bluegray-600 hover:text-bluegray-900" href="{{ route('password.request') }}">
